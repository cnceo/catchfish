...
-(void) addPath
{
    ...
    {
        case 0:
            [self moveWithParabola:self startP:ccp(1200, 200) endP:ccp(-500, 800) startA:0 endA:20 dirTime:(rand()%10+15)/_speed];
            break;
        case 1:
            [self moveWithParabola:self startP:ccp(-200, 300) endP:ccp(1300, 400) startA:180 endA:170 dirTime:(rand()%10+18)/_speed];
            break;
        case 2:
            [self moveWithParabola:self startP:ccp(-200, 300) endP:ccp(1000, -200) startA:190 endA:200 dirTime:(rand()%10+18)/_speed];
            break;
        case 3:
            [self moveWithParabola:self startP:ccp(1300, 400) endP:ccp(-200, 300) startA:10 endA:5 dirTime:(rand()%10+18)/_speed];
            break;
        case 4:
            [self moveWithParabola:self startP:ccp(400, -1200) endP:ccp(600, 1000) startA:90 endA:93 dirTime:(rand()%10+18)/_speed];
            break;
            
        case 5:
            [self moveWithParabola:self startP:ccp(600, 1000) endP:ccp(400, -200) startA:-70 endA:-80 dirTime:(rand()%10+18)/_speed];
            break;
        case 6:
            [self moveWithParabola:self startP:ccp(1200, 2100) endP:ccp(-200, 300) startA:30 endA:-30 dirTime:(rand()%10+18)/_speed];
            break;
    }
